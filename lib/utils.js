  ...
  try {
    const options = {
      ...
      headers: {
        ...
        Authorization:
          "Bearer sendchamp_live_$2a$10$26YJQ8wUOkXDt9L7nKDjh.4TDFE0VkLF5ZU7NSAEfNqQfZoBG18ne",
      },
      body: JSON.stringify({
        to: phoneNumbers,
        message: message,
        sender_name: process.env.SENDCHAMP_SENDER_ID ?? "tlccglobal",
